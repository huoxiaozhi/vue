<template>
  <div class="grid-content bg-purple app-container">
    <div class="filter-container app-container">
      <el-input v-model="courseQuery.name" placeholder="课程名称" class="filter-item" style="width: 200px;"
    ...
    <el-table ref="filterTable" v-loading="listLoading" :data="list" element-loading-text="Loading" size="mini" fit
      ...
      <el-table-column prop="school" label="开课单位" width="100" align="center">
      </el-table-column>
      <el-table-column prop="code" label="课程编码" width="100" align="center">
      </el-table-column>
      <el-table-column prop="name" label="课程名称" width="120" align="center">
      </el-table-column>
      <el-table-column prop="course_attribute" label="课程属性" width="100" align="center">
      </el-table-column>
      <el-table-column prop="subject_major" label="所属学科/专业" width="100" align="center">
      </el-table-column>
      <el-table-column label="课时/学分" width="60" align="center">
        <template slot-scope="scope">
          {{ scope.row.period }}/{{ scope.row.credit }}
        </template>
      </el-table-column>
      <el-table-column prop="capacity" label="限选" width="60" align="center">
      </el-table-column>
      <el-table-column prop="week" label="开课周" width="80" align="center">
      </el-table-column>
      <el-table-column prop="scetion" label="星期节次" width="80" align="center">
      </el-table-column>
      <el-table-column prop="classroom" label="教室" width="80" align="center">
      </el-table-column>
      <el-table-column prop="teaching_mode" label="授课方式" width="80" align="center">
      </el-table-column>
      <el-table-column prop="examination_mode" label="考试方式" width="80" align="center">
      </el-table-column>
      <el-table-column prop="chief_professor" label="首席教授" width="80" align="center">
      </el-table-column>
      <el-table-column prop="lecturer" label="主讲教师" width="80" align="center">
      </el-table-column>
      <el-table-column prop="assistant" label="助教" width="80" align="center">
      </el-table-column>
    </el-table>
  </div>
</template>
